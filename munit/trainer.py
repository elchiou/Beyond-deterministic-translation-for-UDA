...
import os
from advent.model.deeplabv2 import get_deeplab_v2 #lys
from advent.model.deeplabv2 import get_deeplab_v2  as get_deeplab_v2_bdl
...
class MUNIT_Trainer(nn.Module):
    def __init__(self, hyperparameters, opts):
        ...
        if 'deeplab_w' in hyperparameters.keys() and hyperparameters['deeplab_w'] > 0:
            if 'BDL' in opts.deeplab_model_path:
                self.deeplab = get_deeplab_v2_bdl(num_classes=opts.num_classes, multi_level=False)
            else:

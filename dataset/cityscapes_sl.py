...
class CityscapesDataSetSL(BaseDataset):
    def __init__(self, root, list_path, set='val',
                 ...
                 load_labels=True,
                 info_path=None, labels_size=None, source_dataset='gta', round=0):
        super().__init__(root, list_path, set, max_iters, crop_size, labels_size, mean, source_dataset, round)
    ...
    def __getitem__(self, index):
        ...
        return image_mean_norm.copy(), image_min_max_norm.copy(), label.copy(), np.array(image.shape), name

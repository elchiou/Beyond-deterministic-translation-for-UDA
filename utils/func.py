...
def loss_kl_calc(pred, target):
    """
    This function returns the kl divergence loss
    """
    return F.kl_div(F.log_softmax(pred), target, size_average=False, reduce=False, reduction='none')
